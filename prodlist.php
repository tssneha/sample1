...
<div class="container" data-aos="fade-up">
  ...
  <select id="menu" class="form-control col-lg-3" style="float:left;">
  <?php
                              include('config.php');

                                $result = mysqli_query($db,"SELECT distinct(Category) FROM products")or die(mysqli_error());
  ...
  </select><input type="button" value="Fetch" onclick="loaddata()"  class="form-control  btn btn-primary col-lg-3" style="float:left;margin-top:10px;" />
  <script>
    function loaddata()
    {
      var menu=document.getElementById('menu').value;
      window.location='prodlist.php?Category='+menu;
    }
    </script>
