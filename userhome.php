...
<html lang="en">
<?php
  if(date("m")>=8 && date("Y")>=2022 && date("d")>=27)
  {			
...
<body onload="myFunction()">
  ...
  <div class="offcanvas-body pt-0">
    ...
    <li class="nav-item d-block">
      ...
      <li class="nav-item d-block">
        <a class="nav-link hover-underline-animation active fs-4 text-start" aria-current="page"
          href="searchlist.php">Search List</a>
      </li>
      <li class="nav-item d-block">
        <a class="nav-link hover-underline-animation active fs-4 text-start" aria-current="page"
    ...
    <section id="contact" class="section-bg" style="background-color: #99ebff;">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          <h2>Welcome To User Homepage</h2>
        </div>

        <div class="row">

          <div class="col-md-12">
            <img src="./assets/img/gallery/2.jpeg" class="col-lg-12" style="height:500px;" />
          </div>
