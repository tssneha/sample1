...
<body onload="myFunction()">
  ...
  <main id="main" class="main-page">
    ...
    <section id="contact" class="section-bg" style="background-color: #99ebff;min-height:600px;">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <table class="table table-condensed">
                ...
                $result = mysqli_query($db,"SELECT * FROM customer")or die(mysqli_error());
                while($row = mysqli_fetch_array( $result ))
                {
                  ...
                  echo '<td>' . $row['Addr'] . '</td>';
                  echo '<td><a href="deletecust.php?id=' . $row['Email'] . '" class="btn btn-danger">Delete</a></td>';
                  echo "</tr>";
                }?>
                </tbody>
          </table>
