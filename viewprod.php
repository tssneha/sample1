...
<?php
 $pid=$_GET['id'];
 $result = mysqli_query($db,"SELECT * FROM products where Pid='$pid'")or die(mysqli_error());
...
<body onload="myFunction()">
  ...
  <main id="main" class="main-page">
    ...
    <section id="contact" class="section-bg" style="background-color: #99ebff;">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <form id="f1" style="font-weight:bolder;" action="addtocart.php">
        <div class="row">

          <div class="col-md-6">
            <img src="./uploads/<?php echo $row['Filename'];?>" id="student_Img" class="col-lg-12 form-control" style="height:550px;" />
          </div>
          ...
          <div class="col-md-6">
            ...
            <div class="form-group col-lg-12" style="font-size:20px;padding-bottom:10px;">
              ...
              <input type="text" class="form-control" value=<?php echo $row['Pid'];?> id="pid" name="pid" readonly runat="server" placeholder="Enter Name" onchange="valuname()" />
           </div>

           Product Name :
            <div class="form-group col-lg-12" style="font-size:20px;padding-bottom:10px;">
                               
              <input type="text" class="form-control" value=<?php echo $row['Pname'];?> id="name" name="name" readonly runat="server" placeholder="Enter Name" onchange="valuname()" />
           </div>
         ...
         <input type="text" class="form-control" id="category"  value=<?php echo $row['Category'];?> name="category" readonly runat="server" placeholder="Enter Name" onchange="valuname()" />
         ...
         <div class="form-group col-lg-12" style="font-size:20px;padding-bottom:10px;">
           ...
           <input type="phone" class="form-control" id="cost" name="cost"  value=<?php echo $row['Cost'];?>  readonly runat="server" placeholder="Enter Cost" />
        </div>
         Available Quantity :
         <div class="form-group col-lg-12" style="font-size:20px;padding-bottom:10px;">
                            
           <input type="phone" class="form-control" id="cost" name="cost"  value=<?php echo $row['Quantity'];?>  readonly runat="server" placeholder="Enter Cost" />
        </div>

        Product Description :
         <div class="form-group col-lg-12" style="font-size:20px;padding-bottom:10px;">
                            
           <textarea class="form-control" id="descr" name="descr" readonly runat="server" placeholder="Enter description" cols="30"> <?php echo $row['Descr'];?></textarea> 
        </div>

        Enter Quantity :
         <div class="form-group col-lg-12" style="font-size:20px;padding-bottom:10px;">
                            
             <div class="value-button" id="decrease" onclick="decreaseValue()" value="Decrease Value"><span>-</span></div>
         ...
         <div class="form-group col-lg-12" style="font-size:20px;padding-bottom:10px;">
           ...
           <input type="phone" class="form-control" id="tcost" name="tcost" readonly runat="server" placeholder="Enter Cost" />
        </div>
        
        <div class="form-group col-lg-5" style="font-size:20px;padding-bottom:10px;float:left;margin-right: 5px;">
          <input type="submit" value="Add To Cart"class="btn btn-danger col-lg-12" />
       </div>
  ...
  document.getElementById('tcost').value = value*parseFloat(cst);
}
