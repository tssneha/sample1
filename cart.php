...
<body onload="myFunction()">
        ...
        <div class="row">
          ...
          <table class="table table-condensed">
                ...
                <tbody>
                  <?php
 $aby=$_SESSION['uname'];
                $result = mysqli_query($db,"SELECT * FROM cart where Addedby='$aby' and Stat='Pending'")or die(mysqli_error());
                ...
                while($row = mysqli_fetch_array( $result ))
                {
                  ...
                  echo '<td><a href="cartremove.php?id=' . $row['Id'] . '" class="btn btn-danger">Delete</a></td>';
                  echo "</tr>";
                }?>
                </tbody>
          </table>
          <?php
          $result = mysqli_query($db,"SELECT Sum(CAST(Tcost AS UNSIGNED)) as tamt FROM cart where Addedby='$aby' and Stat='Pending' group by Addedby")or die(mysqli_error());
                $totalcost=0;
 ...
 $aby=$_SESSION['uname'];
                ...
                while($row = mysqli_fetch_array( $result ))
                {
                  ...
                  ?>
          <h1>Total Bill Amount : <span style="color:#2337a5;font-weight:bolder;">₹<?php echo $totalcost;?></span></h1>
              <br/>
              <a href="checkout.php?user=<?php echo $aby;?>"  class="btn btn-danger col-lg-4">Checkout</a>
