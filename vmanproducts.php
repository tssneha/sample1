...
<body onload="myFunction()">
    ...
    <ul class="navbar-nav text-center">
      ...
      <li class="nav-item d-block">
        <a class="nav-link hover-underline-animation active fs-4 text-start" aria-current="page"
          href="vproducts.php">Add Products</a>
      </li>
      <li class="nav-item d-block">
        <a class="nav-link hover-underline-animation active fs-4 text-start" aria-current="page"
          href="vmanproducts.php">Manage Products</a>
      </li>
      <li class="nav-item d-block">
        <a class="nav-link hover-underline-animation active fs-4 text-start" aria-current="page"
  ...
  <main id="main" class="main-page">
    ...
    <section id="contact" class="section-bg" style="background-color: #99ebff;min-height:500px;">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <table class="table table-condensed">
                ...
                <?php
                $aby=$_SESSION['uname'];
                $result = mysqli_query($db,"SELECT * FROM products where Addedby='$aby'")or die(mysqli_error());
                while($row = mysqli_fetch_array( $result ))
                {
                  ...
                  echo '<td><img src="./uploads/'. $row['Filename'] .'" style="width:200px;height:200px" /></td>';
                  echo '<td>' . $row['Quantity'] . '</td>';
                  echo '<td>' . $row['Cost'] . '</td>';
                  echo '<td><a href="vdeleteprod.php?id=' . $row['Pid'] . '" class="btn btn-danger">Delete</a></td>';
                  echo "</tr>";
                }?>
                </tbody>
          </table>
